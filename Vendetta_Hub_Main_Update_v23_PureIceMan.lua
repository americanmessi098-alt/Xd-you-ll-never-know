...
IceTweenButton.MouseButton1Click:Connect(function()
    ...
    -- Streaming-safe fixed path: Workspace > chatnpcs > Pure Ice Man > Chat > ActiveIceShard.
    -- No Workspace-wide search is performed.
    local Chat = workspace:FindFirstChild("chatnpcs")
        and workspace.chatnpcs:FindFirstChild("Pure Ice Man")
        and workspace.chatnpcs["Pure Ice Man"]:FindFirstChild("Chat")
