...
--==================================================
--// MAIN — VISUALS + ITEMS + COMBAT
--==================================================

local HealthButton = Button(MainPage,"Health ESP   •   OFF",8)
local NameDistanceButton = Button(MainPage,"Name + Distance ESP   •   OFF",52)
local FluteESPButton = Button(MainPage,"Flute ESP   •   OFF",96)
local EarringsESPButton = Button(MainPage,"Earrings ESP   •   OFF",140)
local IceESPButton = Button(MainPage,"Ice Shard ESP   •   OFF",184)

local FluteTween = Button(MainPage,"Tween → Flute",228)
local EarringsTween = Button(MainPage,"Tween → Earrings",272)
local IceTweenButton = Button(MainPage,"Tween → Active Ice Shard",316)

local BlockButton = Button(MainPage,"Auto Block   •   OFF",360)
local ArmButton = Button(MainPage,"No Arm   •   OFF",404)
local HitboxButton = Button(MainPage,"Hitbox ESP   •   OFF",448)
local BreathingButton = Button(MainPage,"Auto Breathing   •   OFF",492)
local KatanaButton = Button(MainPage,"Katana Hide   •   OFF",536)
local BlockBreakButton = Button(MainPage,"Block Break Macro   •   OFF",580)
local StrongAttackButton = Button(MainPage,"Auto Strong Attack   •   OFF",624)
local ComboLeaverButton = Button(MainPage,"Combo Leaver",668)

local FriendTitle = Label(MainPage,"MANUAL FRIEND IGNORE",712)
local FriendBox = Instance.new("TextBox",MainPage)
FriendBox.Size = UDim2.new(1,-116,0,38)
FriendBox.Position = UDim2.fromOffset(6,746)
...
local AddFriendButton = Button(MainPage,"ADD",752)
AddFriendButton.Size = UDim2.fromOffset(48,38)
AddFriendButton.Position = UDim2.new(1,-104,0,746)
local RemoveFriendButton = Button(MainPage,"REMOVE",804)
RemoveFriendButton.Size = UDim2.fromOffset(98,38)
RemoveFriendButton.Position = UDim2.fromOffset(6,792)

local FriendListLabel = Label(MainPage,"Ignored: none",846)
FriendListLabel.TextWrapped = true
FriendListLabel.Size = UDim2.new(1,-12,0,60)

-- FOV changer
Label(MainPage,"FOV CHANGER",914)
local FOVBox = Instance.new("TextBox",MainPage)
FOVBox.Size = UDim2.fromOffset(90,38)
FOVBox.Position = UDim2.fromOffset(6,946)
FOVBox.Text = "70"
FOVBox.TextSize = 13
...
local FOVApplyButton = Button(MainPage,"Apply FOV",946)
FOVApplyButton.Size = UDim2.fromOffset(110,38)
FOVApplyButton.Position = UDim2.fromOffset(104,946)
