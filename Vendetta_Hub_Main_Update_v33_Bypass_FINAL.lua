...
--==================================================
--// BYPASS BUTTON
--// Uses Vendetta Hub's existing Players / RunService / LocalPlayer / PlayerGui.
--// No duplicate service or player declarations.
--==================================================
...
local function StartBypass()
    ...
    BypassHeartbeatConn = RS.Heartbeat:Connect(function()
        if not BypassEnabled then return end
        if not BypassRunBtn or not BypassRunBtn.Parent then return end
        pcall(function()
