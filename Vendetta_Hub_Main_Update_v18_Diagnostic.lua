...
print("[VENDETTA DIAGNOSTIC] 01 - script entered")
...
print("[VENDETTA DIAGNOSTIC] 02 - services/player loaded")
...
GUI.Parent = PG
print("[VENDETTA DIAGNOSTIC] 03 - main ScreenGui created")
...
ShowPage("Main")
print("[VENDETTA DIAGNOSTIC] 04 - pages/tabs initialized")
...
local AcquisitionDesyncToken = 0
...
local function StartInventoryDesync()
    StopInventoryDesync()
    AcquisitionDesyncToken += 1
    local ThisToken = AcquisitionDesyncToken
    ...
    task.delay(3, function()
        if AcquisitionDesyncRunning and AcquisitionDesyncToken == ThisToken then
            StopInventoryDesync()
        end
    end)
end
...
local BlockRemote = EventsFolder and EventsFolder:FindFirstChild("remote")
print("[VENDETTA DIAGNOSTIC] 05 - auto-block remote " .. (BlockRemote and "found" or "not found; continuing"))
...
local FeatureEventsFolder = ReplicatedStorage:FindFirstChild("events")
local FeatureRemote = FeatureEventsFolder and FeatureEventsFolder:FindFirstChild("remote")
print("[VENDETTA DIAGNOSTIC] 06 - feature remote " .. (FeatureRemote and "found" or "not found; continuing"))
...
print("[VENDETTA DIAGNOSTIC] STARTUP COMPLETE - reached end of source")
