...
-- Physics-based fall-damage mitigation (no hooks)
...
--==================================================
--// OP TAB — BYPASS + AUTO GET BREATHINGS/BDAS
--==================================================
...
local function TweenPlayerTo(Pos, Dur)
    local char = LP.Character
    local root = char and char:FindFirstChild("HumanoidRootPart")
    if not root then return end
    local dist = (Pos - root.Position).Magnitude
    local dur  = Dur or math.max(2, math.min(8, dist / 150))
    local t = TS:Create(root,
...
local function BuildAutoGUI(Title, Items, OnSelect, DefaultPos, ItemHeight)
    ItemHeight = ItemHeight or 34

    -- Root container holds either body or mini
...
local function FindNPC(Text)
    ...
    for _,Object in ipairs(workspace:GetDescendants()) do
        if Object:IsA("Model") and Object ~= LP.Character then
            ...
            if Humanoid and Object.Name:lower() == Query then return Object end
        end
    end
    for _,Object in ipairs(workspace:GetDescendants()) do
        if Object:IsA("Model") and Object ~= LP.Character then
            local Humanoid = Object:FindFirstChildOfClass("Humanoid")
            if Humanoid and Object.Name:lower():sub(1,#Query) == Query then return Object end
        end
    end
    return nil
end
